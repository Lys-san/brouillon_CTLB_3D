...
\textbf{Note} : Est-ce vraiment vrai pour $c$ défini comme la taille des arêtes du cube ? Si on prend $A$ et $B$ situées sur deux sommets en diagonale d'une même face, on a bien $d(A, B) > c$ or il existe une droite de courbure totale nulle reliant ces points.
...
Soient $A$ et $B$ situés sur des faces opposées. On sait que la ligne polygonale entre $A$ et $B$ est nécessairement formée par quatre points $A$, $B$, $C$ et $D$.
\end{new}
% avec 
% \begin{align*}
%     d &= AB,\\
