...
Notons $A'$ et $B'$ les projetés orthogonaux respectifs de $A$ et $B$ sur l'arête.
Soit $C \in [A', B']$.
Notons $\theta := \kappa([A, C, B])$.
...
Comme la fonction cosinus est continue, on sait par le théorème des valeurs intermédiaires que $f$ est soit positive soit négative sur $[z_A, z_B]$. Le dénominateur était positif car produit de fonctions positives, on se restreint à l'étude de signe du numérateur $u(z_C)$.\\
